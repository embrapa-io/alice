...
**Versão**: 1.26.4-7 | **Compatível com**: BMAD Core v6 | **Convenção de versão**: `1.YY.MM`
...
- **2026-03-30**: v1.26.4-7 — Validação de módulo, criação de module-help.csv, consolidação de metadados
