---
name: embrapa-io-setup
description: Sets up Embrapa I/O DevOps Compliance Module in a project. Use when the user requests to 'install embrapa-io module', 'configure Embrapa I/O', or 'setup Embrapa I/O'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/embrapa-io/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code embrapa-io
```
